...
WebUI.click(findTestObject('Page_Pc Zone/a_Buy Now1'))

WebUI.click(findTestObject('Page_Pc Zone/button_'))

WebUI.verifyTextPresent('INTEL 2066 CORE I9-10900X', false)
