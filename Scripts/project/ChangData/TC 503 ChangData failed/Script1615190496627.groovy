...
WebUI.setText(findTestObject('Object Repository/Page_/input__Fname'), '')

WebUI.click(findTestObject('Object Repository/Page_/div_'))

WebUI.setText(findTestObject('Object Repository/Page_/input__Lname'), '')

WebUI.click(findTestObject('Object Repository/Page_/button_'))

WebUI.verifyTextPresent('ข้อมูลผู้ใช้', false)
